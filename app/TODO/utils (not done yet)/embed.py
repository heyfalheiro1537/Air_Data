...
def split_text_into_sections(text, min_chars_per_section):
    ...
    for paragraph in paragraphs:
        ...
        if (
            current_length + paragraph_length + 2 <= min_chars_per_section
        ):  # +2 for the double newline
...
def embed_text_in_chromadb(
    text, document_name, document_description, persist_directory=Utils.DB_FOLDER
):
